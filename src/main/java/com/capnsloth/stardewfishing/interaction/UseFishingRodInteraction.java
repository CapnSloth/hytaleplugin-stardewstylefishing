    ...
    protected void firstRun(@NonNull InteractionType interactionType, @NonNull InteractionContext context, @NonNull CooldownHandler cooldownHandler) {
        ...
        if (metadata.bobberUUID != null &&
            ...
            if (bobberComponent.isFishOn) {
                ...
                //Move bar up.
                bobberComponent.barVelocity = Math.clamp(bobberComponent.barVelocity + (bobberComponent.barSpeed * bobberComponent.barAcceleration) + (bobberComponent.barGravity*bobberComponent.barAcceleration), bobberComponent.barGravity, bobberComponent.barSpeed);
